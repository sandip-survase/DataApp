...
public class PlacemeProAdmin extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_placeme_pro_admin);
        ...
        actionBar.setBackgroundDrawable(new ColorDrawable(PlacemeProAdmin.this.getResources().getColor(R.color.transperent)));
        ...
        TextView uploadresumetxt=(TextView)findViewById(R.id.uploadresumetxt);
        TextView uploadtxt=(TextView)findViewById(R.id.uploadtxt);
        TextView createtxt=(TextView)findViewById(R.id.createtxt);
        TextView createadmin=(TextView)findViewById(R.id.createadmin);
        ...
        uploadresumetxt.setTypeface(custom_font3);
        createtxt.setTypeface(custom_font3);
        ...
        uploadtxt.setTypeface(custom_font4);
        createadmin.setTypeface(custom_font4);

        knowmoretxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i2 = new Intent(PlacemeProAdmin.this, KnowMoreAdminActivity.class);
                startActivity(i2);
        ...
        switchtorl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PlacemeProAdmin.this,SwitchToProActivity.class));
            }
        });
    }
    @Override
