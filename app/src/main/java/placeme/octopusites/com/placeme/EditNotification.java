...
//              Toast.makeText(AdminActivity.this, "total_no_of_notifications"+total_no_of_notifications, Toast.LENGTH_LONG).show();
                ...
                Log.d("EditNotifflog",":GetNotificationsReadStatus::");
                Log.d("EditNotifflog",":total_no_of_notifications::"+total_no_of_notifications);
                Log.d("EditNotifflog",":notificationpages::"+notificationpages);
                Log.d("EditNotifflog",": unreadcountNotification::"+unreadcountNotification);
        ...
        protected void onPostExecute(String result) {
            ...
            for(int i=0;i<notificationcount;i++)
                try
                {
                    ...
                    Log.d("in..GetNotifications",":notificationcount::"+notificationcount);
...
//                      Toast.makeText(AdminActivity.this, "title"+notificationtitles[i], Toast.LENGTH_SHORT).show();
                        Log.d("",":   notificationtitles::"+   notificationtitles[i]);
...
//                        Log.d("",":   notificationtitles::"+   notificationtitles[i]);
                    ...
                    if(notificationuploadedby[i]!=null)
                    {
                        ...
                        Log.d("onpost",":   notificationtitles::"+   notificationuploadedbyplain[i]);
                    }
...
//                            Toast.makeText(this, "notification read status here:-"+notificationreadstatus, Toast.LENGTH_LONG).show();
            ...
            selectedPositions=new int[notificationcount];
            selectedViews=new View[notificationcount];
        }
    ...
    class DeleteNotifications extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... param) {
            ...
            json = jParser.makeHttpRequest(url_Delete_Notification, "GET", params);
            try {
