...
public class HrContactDetails extends AppCompatActivity {
...
//    private static String   URL_SAVE_HR_CONTACT_DETAILS = "http://192.168.100.10/AESTest/SaveHrContact1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hr_contact_details);
    ...
    class SaveDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("success"))
            {
                ...
                Toast.makeText(HrContactDetails.this,result,Toast.LENGTH_SHORT).show();
