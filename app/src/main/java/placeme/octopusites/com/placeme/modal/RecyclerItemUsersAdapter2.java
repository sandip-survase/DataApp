...
public class RecyclerItemUsersAdapter2 extends RecyclerView.Adapter<RecyclerItemUsersAdapter2.MyViewHolder> {
    Context mContext;
    int flag;
    String TAG = "RecyclerItemUsersAdapter";
    private ArrayList<RecyclerItemUsers> itemList;

    public RecyclerItemUsersAdapter2(ArrayList<RecyclerItemUsers> itemList, Context mContext, int flag) {
