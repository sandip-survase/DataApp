        ...
        if (edittedFlag == 1) {
            ...
            alertDialog.setOnShowListener(new DialogInterface.OnShowListener() {
                ...
                public void onShow(DialogInterface dialogInterface) {
                    ...
                    alertDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTypeface(Z.getBold(HrIntro.this));
                    alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTypeface(Z.getBold(HrIntro.this));
                }
            });
