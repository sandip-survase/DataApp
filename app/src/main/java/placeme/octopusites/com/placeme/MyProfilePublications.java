...
public class MyProfilePublications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addmorepublicationtxt.setTypeface(Z.getBold(this));
        publicationtxt.setTypeface(Z.getBold(this));


        title1.setTypeface(Z.getBold(this));
        publication1.setTypeface(Z.getBold(this));
        author1.setTypeface(Z.getBold(this));
        url1.setTypeface(Z.getBold(this));
        description1.setTypeface(Z.getBold(this));
        publicationdate1.setTypeface(Z.getBold(this));
        title2.setTypeface(Z.getBold(this));
        publication2.setTypeface(Z.getBold(this));
        author2.setTypeface(Z.getBold(this));
        url2.setTypeface(Z.getBold(this));
        description2.setTypeface(Z.getBold(this));
        publicationdate2.setTypeface(Z.getBold(this));
        title3.setTypeface(Z.getBold(this));
        publication3.setTypeface(Z.getBold(this));
        author3.setTypeface(Z.getBold(this));
        url3.setTypeface(Z.getBold(this));
        description3.setTypeface(Z.getBold(this));
        publicationdate3.setTypeface(Z.getBold(this));
        title4.setTypeface(Z.getBold(this));
        publication4.setTypeface(Z.getBold(this));
        author4.setTypeface(Z.getBold(this));
        url4.setTypeface(Z.getBold(this));
        description4.setTypeface(Z.getBold(this));
        publicationdate4.setTypeface(Z.getBold(this));
        title5.setTypeface(Z.getBold(this));
        publication5.setTypeface(Z.getBold(this));
        author5.setTypeface(Z.getBold(this));
        url5.setTypeface(Z.getBold(this));
        description5.setTypeface(Z.getBold(this));
        publicationdate5.setTypeface(Z.getBold(this));
        title6.setTypeface(Z.getBold(this));
        publication6.setTypeface(Z.getBold(this));
        author6.setTypeface(Z.getBold(this));
        url6.setTypeface(Z.getBold(this));
        description6.setTypeface(Z.getBold(this));
        publicationdate6.setTypeface(Z.getBold(this));
        title7.setTypeface(Z.getBold(this));
        publication7.setTypeface(Z.getBold(this));
        author7.setTypeface(Z.getBold(this));
        url7.setTypeface(Z.getBold(this));
        description7.setTypeface(Z.getBold(this));
        publicationdate7.setTypeface(Z.getBold(this));
        title8.setTypeface(Z.getBold(this));
        publication8.setTypeface(Z.getBold(this));
        author8.setTypeface(Z.getBold(this));
        url8.setTypeface(Z.getBold(this));
        description8.setTypeface(Z.getBold(this));
        publicationdate8.setTypeface(Z.getBold(this));
        title9.setTypeface(Z.getBold(this));
        publication9.setTypeface(Z.getBold(this));
        author9.setTypeface(Z.getBold(this));
        url9.setTypeface(Z.getBold(this));
        description9.setTypeface(Z.getBold(this));
        publicationdate9.setTypeface(Z.getBold(this));

        title10.setTypeface(Z.getBold(this));
        publication10.setTypeface(Z.getBold(this));
        author10.setTypeface(Z.getBold(this));
        url10.setTypeface(Z.getBold(this));
        description10.setTypeface(Z.getBold(this));
        publicationdate10.setTypeface(Z.getBold(this));



        titleinput1.setTypeface(Z.getLight(this));
        publicationinput1.setTypeface(Z.getLight(this));
        authorsinput1.setTypeface(Z.getLight(this));
        publicationdateinput1.setTypeface(Z.getLight(this));

        titleinput2.setTypeface(Z.getLight(this));
        publicationinput2.setTypeface(Z.getLight(this));
        authorsinput2.setTypeface(Z.getLight(this));
        publicationdateinput2.setTypeface(Z.getLight(this));
        titleinput3.setTypeface(Z.getLight(this));
        publicationinput3.setTypeface(Z.getLight(this));
        authorsinput3.setTypeface(Z.getLight(this));
        publicationdateinput3.setTypeface(Z.getLight(this));
        titleinput4.setTypeface(Z.getLight(this));
        publicationinput4.setTypeface(Z.getLight(this));
        authorsinput4.setTypeface(Z.getLight(this));
        publicationdateinput4.setTypeface(Z.getLight(this));
        titleinput5.setTypeface(Z.getLight(this));
        publicationinput5.setTypeface(Z.getLight(this));
        authorsinput5.setTypeface(Z.getLight(this));
        publicationdateinput5.setTypeface(Z.getLight(this));
        titleinput6.setTypeface(Z.getLight(this));
        publicationinput6.setTypeface(Z.getLight(this));
        authorsinput6.setTypeface(Z.getLight(this));
        publicationdateinput6.setTypeface(Z.getLight(this));
        titleinput7.setTypeface(Z.getLight(this));
        publicationinput7.setTypeface(Z.getLight(this));
        authorsinput7.setTypeface(Z.getLight(this));
        publicationdateinput7.setTypeface(Z.getLight(this));
        titleinput8.setTypeface(Z.getLight(this));
        publicationinput8.setTypeface(Z.getLight(this));
        authorsinput8.setTypeface(Z.getLight(this));
        publicationdateinput8.setTypeface(Z.getLight(this));
        titleinput9.setTypeface(Z.getLight(this));
        publicationinput9.setTypeface(Z.getLight(this));
        authorsinput9.setTypeface(Z.getLight(this));
        publicationdateinput9.setTypeface(Z.getLight(this));
        titleinput10.setTypeface(Z.getLight(this));
        publicationinput10.setTypeface(Z.getLight(this));
        authorsinput10.setTypeface(Z.getLight(this));
        publicationdateinput10.setTypeface(Z.getLight(this));
        urlinput1.setTypeface(Z.getLight(this));
        descriptioninput1.setTypeface(Z.getLight(this));
        descriptioninput2.setTypeface(Z.getLight(this));
        urlinput3.setTypeface(Z.getLight(this));
        descriptioninput3.setTypeface(Z.getLight(this));
        urlinput4.setTypeface(Z.getLight(this));
        descriptioninput4.setTypeface(Z.getLight(this));
        urlinput5.setTypeface(Z.getLight(this));
        descriptioninput5.setTypeface(Z.getLight(this));
        urlinput6.setTypeface(Z.getLight(this));
        descriptioninput6.setTypeface(Z.getLight(this));
        urlinput7.setTypeface(Z.getLight(this));
        descriptioninput7.setTypeface(Z.getLight(this));
        urlinput8.setTypeface(Z.getLight(this));
        descriptioninput8.setTypeface(Z.getLight(this));
        urlinput9.setTypeface(Z.getLight(this));
        descriptioninput9.setTypeface(Z.getLight(this));
    ...
    void showDeletDialog() {
        ...
        alertDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialogInterface) {
                ...
                alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTypeface(Z.getBold(MyProfilePublications.this));
                alertDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTypeface(Z.getBold(MyProfilePublications.this));
            }
        });
...
//                    Toast.makeText(getActivity(), "bln "+bln, Toast.LENGTH_SHORT).show();
    ...
    class SavePublications extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... param) {
            ...
            json = jParser.makeHttpRequest(Z.url_savepublications, "GET", params);
            try {
