...
public class QuestionsetsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionsets);
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#ffffff'>Question Sets</font>"));
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                Toast.makeText(QuestionsetsActivity.this,query,Toast.LENGTH_LONG).show();
                return false;
            }
